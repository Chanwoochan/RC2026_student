 ...
 * Change Ros2 Version : Chanwoo Kim
 * 
 * ======
 * Update date : 2022.03.16 by Yunho Han
 * Ros2 Version Update date : 2025.03.31 by Chanwoo Kim
 * ======
 */
...
//* Header file for Gazebo and Ros2
...
void gazebo::rok3_plugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    ...
    rok3_model = new Model();
    Addons::URDFReadFromFile("/home/user_name/.gazebo/models/RoK3/urdf/rok3.urdf", rok3_model, true, true);
    //↑↑↑ Check File Path ↑↑↑
    ...
    ros2_node_ = gazebo_ros::Node::Get(_sdf);
